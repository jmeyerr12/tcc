...
#define PRI_PLUGIN_NAME "21354"
#define SEC_PLUGIN_NAME "21355"
...
class DnsQueryFlowData : public FD_TYPE
{
public:
    DnsQueryFlowData()
        : FD_TYPE(FD_ARGS(id, PRI_PLUGIN_NAME)) {}
